...
object ConnectionTrace {
    ...
    enum class Step(val label: String) {
        ...
        QR_PARSED("QR_PARSED"),
        PHONE_HOTSPOT_REQUIRED("PHONE_HOTSPOT_REQUIRED"),
        PHONE_HOTSPOT_ENABLED("PHONE_HOTSPOT_ENABLED"),
        BLUETOOTH_PROVISION_STARTED("BLUETOOTH_PROVISION_STARTED"),
        BLUETOOTH_DEVICE_FOUND("BLUETOOTH_DEVICE_FOUND"),
        BLUETOOTH_RFCOMM_CONNECTED("BLUETOOTH_RFCOMM_CONNECTED"),
        EBT_CONN_TYPE_P2C_SENT("EBT_CONN_TYPE_P2C_SENT"),
        EBT_CLIENT_INFO_SENT("EBT_CLIENT_INFO_SENT"),
        EBT_HOTSPOT_REQUEST_RECEIVED("EBT_HOTSPOT_REQUEST_RECEIVED"),
        EBT_AP_INFO_SENT("EBT_AP_INFO_SENT"),
        MOTORCYCLE_WIFI_PROVISIONED("MOTORCYCLE_WIFI_PROVISIONED"),
        MOTORCYCLE_JOINED_HOTSPOT("MOTORCYCLE_JOINED_HOTSPOT"),
