...
class ConnectionTraceTest {
    ...
    fun testTraceProgression() {
        ...
        ConnectionTrace.transition(ConnectionTrace.Step.P2P_CONNECTION_REQUESTED)
        ...
        ConnectionTrace.transition(ConnectionTrace.Step.CLIENT_INFO_RECEIVED)
    ...
    fun testFailureTransition() {
        ...
        assertEquals(ConnectionTrace.Step.P2P_CONNECTION_REQUESTED, ConnectionTrace.lastFailure?.failedStep)
